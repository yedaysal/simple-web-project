...
A modern web project to build, package and deploy a simple web service.
...
- Detailed instructions on how to build and deploy the application, and monitor underlying kubernetes environment
